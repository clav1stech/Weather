...
avec les réglages neige : magasin PRIMAIRE quand WEATHER_STORE est positionné,
parquet git en BACKUP automatique au moindre échec ou résultat vide. Flag
absent → lecture git strictement inchangée.
