...
---
**Pré-release publiée sur `dev/snow` sans merge dans `main`**, à la demande
explicite de l'utilisateur — le dashboard neige n'est pas encore en
production (cf. `CLAUDE.md` § Versioning, exception « Pré-release avant
merge »).
